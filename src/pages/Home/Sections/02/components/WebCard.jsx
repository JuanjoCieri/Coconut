export default function WebCard() {
  return (
    <div className="w-[450px] h-[450px] rounded-lg bg-[url('/src/assets/Section02/WebDevelopment.png')] flex flex-col justify-between px-4 py-6">
      <div>
        <h3 className="text-6xl text-white">Web Development</h3>
      </div>
