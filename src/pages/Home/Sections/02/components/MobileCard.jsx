export default function MobileCard() {
  return (
    <div className="w-[450px] h-[450px] rounded-lg bg-[url('/src/assets/Section02/MobileAppDesign.png')] flex flex-col justify-between px-4 py-6">
      <div>
        <h3 className="text-6xl text-white">Mobile App Design</h3>
      </div>
